...
- Create Angular project with ng: `ng new it310finalproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`it310finalproject.client.esproj`).
